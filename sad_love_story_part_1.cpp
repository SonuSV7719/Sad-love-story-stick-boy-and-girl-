...
int main()
{
	...
	//stick man propose 10
	    ...
	    if(n>60&&n<=70)
	    {
	    	...
	    	delay(300);
		    road(13);
			stickman_rose(speedMan,14);
			if(n==61)
			stickman_chat(speedMan,14,14);
			if(n==62)
			delay(4000);
	    	stickwomen_open(280,15);
	    	if(n==63)
	...
	//stick women walk 70
		...
		if(n>70&&n<=170)
		{
			...
			stickman_rose(speedMan,14);
			if(n%2==0)
			stickwomen_open(280+speedWomen,15);
			else
			stickwomen_close(280+speedWomen,15);
			speedWomen+=4;
		}
    //cloud move 50
	...
	//rose break and starting rain
		...
		{
		    road(13);
			stickman_rose_break(speedMan,14);
			cloud(speedMan,15);
			rain(speedMan,2);
		}
